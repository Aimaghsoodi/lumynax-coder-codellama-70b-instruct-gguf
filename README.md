...
[🤗 Weights & model card on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-coder-codellama-70b-instruct-gguf) · [abteex.com](https://abteex.com) · [lumynax.com](https://lumynax.com) · [Monorepo](https://github.com/Aimaghsoodi/lumynax-release)

---

This GitHub repo mirrors the **runtime scaffolding** (quickstart, requirements, Modelfile, Space, docs). The model **weights** are published on Hugging Face at `AbteeXAILab/lumynax-coder-codellama-70b-instruct-gguf` — they exceed GitHub's per-file limit.

```bash
hf download AbteeXAILab/lumynax-coder-codellama-70b-instruct-gguf --local-dir lumynax-coder-codellama-70b-instruct-gguf
cd lumynax-coder-codellama-70b-instruct-gguf && pip install -r requirements.txt && python quickstart.py --interactive
# Or:  pip install lumynax && lumynax run lumynax-coder-codellama-70b-instruct-gguf -i
```
